                ...
                <tbody>
                  ...
                  <?php foreach ($users as $usr) : ?>
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-pill badge-default border-><?= ($usr->name == 'admin') ? '-primary bg-gradient-primary text-white' : '-info bg-gradient-info text-white' ?>"><?= $usr->name; ?></span>
                      </td>
                      <td class="text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a href="/pengguna/edit/<?= $usr->userid; ?>" class="text-primary font-weight-bold text-xs ps-1" data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt text-primary me-0" aria-hidden="true"></i>
                          Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;

                        <form action="/pengguna/<?= $usr->userid; ?>" method="post" class="d-inline">
