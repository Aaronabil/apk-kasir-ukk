      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <h6><i class="ni ni-satisfied text-dark align-items-center" aria-hidden="true"></i>&nbsp;Edit Pengguna</h6>
            ...
            <form action="/pengguna/update/<?= $users['id']; ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" class="form-control <?php if (session('errors.Email')) : ?>is-invalid<?php endif ?>" id="Email" name="Email" value="<?= $users['email'] ?>" placeholder="Edit Email" autofocus autocomplete="off">
                  <div class="ms-2">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?php if (session('errors.namaPengguna')) : ?>is-invalid<?php endif ?>" id="namaPengguna" name="namaPengguna" autofocus value="<?= $users['username'] ?> " autocomplete="off" placeholder="Edit Username atau Nama Pengguna">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?php foreach (session('errors') as $field => $error) : ?>
                        <?php if ($field === 'namaPengguna') : ?>
                          <span class="text-danger text-sm"><?= $error ?></span>
                        <?php endif; ?>
                      <?php endforeach; ?>
                    <?php endif; ?>
