            ...
            <form action="/pelanggan/update/<?= $pelanggan['PelangganID']; ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control <?php if (session('errors.namaPelanggan')) : ?>is-invalid<?php endif ?>" id="namaPelanggan" name="namaPelanggan" value="<?= ucwords($pelanggan['nama_pelanggan']) ?>" placeholder="Edit Nama Pelanggan" autofocus autocomplete="off">
                  <div class="ms-2">
                ...
                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" class="form-control <?php if (session('errors.Alamat')) : ?>is-invalid<?php endif ?>" id="Alamat" name="Alamat" autofocus value="<?= ucwords($pelanggan['alamat']) ?>" autocomplete="off" placeholder="Edit Alamat">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?php foreach (session('errors') as $field => $error) : ?>
                        <?php if ($field === 'Alamat') : ?>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control <?php if (session('errors.noTelepon')) : ?>is-invalid<?php endif ?>" id="noTelepon" name="noTelepon" autofocus value="<?= $pelanggan['nomor_telepon'] ?>" autocomplete="off" placeholder="Edit Nomor Telepon">
                  <div class="ms-2">
                    <?php if (session()->has('errors')) : ?>
                      <?php foreach (session('errors') as $field => $error) : ?>
                        <?php if ($field === 'noTelepon') : ?>
                          <span class="text-danger text-sm"><?= $error ?></span>
                        <?php endif; ?>
                      <?php endforeach; ?>
                    <?php endif; ?>
