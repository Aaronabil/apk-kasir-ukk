                  ...
                  <?php foreach ($tb_pelanggan as $plg) : ?>
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a href="/pelanggan/edit/<?= $plg['PelangganID']; ?>" class="text-primary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt text-primary me-0" aria-hidden="true"></i>
                          Edit
                        </a>
                        &nbsp;&nbsp;&nbsp;
                        <form action="/pelanggan/<?= $plg['PelangganID']; ?>" method="post" class="d-inline">
                          ...
                          <button type="submit" style="border: none; background-color: Transparent;" onclick="return confirm('Hapus data pelanggan <?= $plg['nama_pelanggan']; ?>?');"><a class="text-danger font-weight-bold text-xs ps-1" data-toggle="tooltip" data-original-title="Edit user"><i class="far fa-trash-alt me-0"></i>
                              Hapus
                            </a></button>
                        </form>
                      </td>
