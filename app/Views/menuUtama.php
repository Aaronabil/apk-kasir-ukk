    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h3 class="font-weight-bolder text-white mb-0">Hello, <?= ucwords(user()->username); ?></h3>
                <?php foreach ($users as $usr) : ?>
                    <span class="badge badge-pill badge-default border<?php echo ($usr->name == 'admin') ? '-primary bg-gradient-primary text-white' : '-info bg-gradient-info text-white' ?>"><?php echo $usr->name; ?></span>
                <?php endforeach; ?>
            </nav>
